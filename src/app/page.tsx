   ...
   return (
      <div className="flex flex-col min-h-screen">
         ...
         <main className="flex-1">
            ...
            <section id="mascotas" className="w-full py-12 md:py-24 lg:py-32">
               <div className="container px-4 md:px-6">
                  <div className="flex flex-col items-center justify-center space-y-4 text-center">
                     <div className="space-y-2">
                        <div className="inline-block rounded-lg bg-neutral-100 px-3 py-1 text-sm dark:bg-neutral-800">Tus Mascotas</div>
                        <h2 className="text-3xl font-bold tracking-tighter md:text-4xl/tight">Tu Lista de Mascotas</h2>
                        <p className="max-w-[900px] text-neutral-500 md:text-xl/relaxed lg:text-base/relaxed xl:text-xl/relaxed dark:text-neutral-400">
                           Veremos si puede traer la lista de mascotas de la DB
                        </p>
                     </div>
                  </div>
               ...
               <div className="container px-4 md:px-6">
                  <div className="flex flex-col items-center justify-center space-y-4 text-center">
                     <div className="space-y-2">
                        ...
                        <p className="max-w-[600px] text-neutral-500 md:text-xl dark:text-neutral-400">Stay updated with the latest product news and updates.</p>
                     </div>
